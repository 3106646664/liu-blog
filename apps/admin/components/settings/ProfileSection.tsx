          ...
          <div className="flex-1 w-full space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <input type="text" value={safeData.title || ''} onChange={e => handleUpdate('title', e.target.value)} placeholder="例如: Xinghui Blog" className="w-full bg-white/50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl px-4 py-3 text-sm mt-1 outline-none font-bold focus:ring-2 focus:ring-indigo-500" />
              </div>
              ...
              <div className="col-span-1 md:col-span-2 pt-4 border-t border-slate-200 dark:border-slate-700/50 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="text-[10px] font-black text-slate-400 uppercase ml-1">个人网站</label>
                  <input type="text" value={safeSocial.website || ''} onChange={e => handleSocialUpdate('website', e.target.value)} className="w-full bg-white/50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl px-4 py-3 text-sm mt-1 outline-none" />
                </div>
                <div>
                  <label className="text-[10px] font-black text-slate-400 uppercase ml-1">哔哩哔哩主页</label>
                  <input type="text" value={safeSocial.bilibili || ''} onChange={e => handleSocialUpdate('bilibili', e.target.value)} className="w-full bg-white/50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl px-4 py-3 text-sm mt-1 outline-none" />
                </div>
              </div>
              ...
              <div className="col-span-1 md:col-span-2 pt-4 border-t border-slate-200 dark:border-slate-700/50">
                ...
                <textarea
                  ...
                  placeholder="名称：Example Blog\n简介：A personal blog\n链接：https://example.com\n头像：https://example.com/avatar.svg"
