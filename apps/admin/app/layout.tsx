...
import DeployStatusOverlay from '../components/DeployStatusOverlay';
              ...
              <MusicProvider>
                <div id="app-mount-root" className="relative isolate flex-1 flex flex-col transition-opacity duration-1000">
                  ...
                  >
                    ...
                    {siteConfig.useGradient && (
                      <>
                        <div className="absolute top-[-10%] left-[-10%] z-[3] w-[40%] h-[40%] bg-white/40 dark:bg-indigo-900/20 blur-[100px] rounded-full mix-blend-overlay"></div>
                        <div className="absolute bottom-[-10%] right-[-10%] z-[3] w-[40%] h-[40%] bg-indigo-400/30 dark:bg-purple-900/30 blur-[100px] rounded-full mix-blend-overlay"></div>
                      </>
                    )}
